...
class PromptBuilder:
    ...
    def build_decision_prompt(self, user_prompt: str) -> str:
        ...
        prompt = (
            ...
            "- Only use 'computer_use' for purely local OS-level tasks (like just toggling/opening/closing an application locally without web surfing).\n\n"
            "INSTRUCTIONS:\n"
            "1. Analyze the user's prompt step-by-step.\n"
            "2. Compare the user's intent with the 'description' of the AVAILABLE SKILLS and the HEURISTICS.\n"
